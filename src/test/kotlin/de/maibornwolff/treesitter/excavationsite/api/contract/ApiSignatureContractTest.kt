...
class ApiSignatureContractTest {
    ...
    inner class LanguageEnumContract {
        @Test
        fun `should have exactly 20 language values`() {
            // Assert
            assertThat(Language.entries).hasSize(20)
        }
        ...
        @Test
        fun `should contain SCALA`() {
            // Assert
            assertThat(Language.valueOf("SCALA")).isEqualTo(Language.SCALA)
        }
